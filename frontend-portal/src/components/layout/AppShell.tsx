    ...
    return (
        <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-50 via-indigo-50/30 to-sky-50/60 dark:from-slate-950 dark:via-indigo-950/20 dark:to-sky-950/10">
            ...
            <div className="pointer-events-none fixed inset-0 -z-10">
                <div className="absolute -left-40 top-20 h-96 w-96 rounded-full bg-indigo-300/25 blur-3xl dark:bg-indigo-500/10" />
                <div className="absolute right-[-8rem] top-1/3 h-80 w-80 rounded-full bg-sky-300/25 blur-3xl dark:bg-sky-500/10" />
            </div>
