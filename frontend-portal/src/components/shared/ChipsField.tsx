 ...
 * with the same UX.
 *
 * Optional `suggestions` enables a type-ahead dropdown (e.g. the referred job's
 * required skills); clicking one adds it. Matching and de-duplication are
 * case-insensitive.
 */
export function ChipsField({
    label, optional, chips, onRemove,
    inputValue, onInputChange, onKeyDown, onAdd, onAddValue,
    ...
    onAdd: () => void
    /** Add a specific value (used when a suggestion is picked). */
