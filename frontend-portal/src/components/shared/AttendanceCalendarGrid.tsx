...
const CODE_META: Record<string, CodeMeta> = {
    P: { label: 'Present', short: 'P', bg: 'bg-white dark:bg-transparent', text: 'text-foreground', weight: 'plain' },
    'P-late': { label: 'Late', short: 'P', bg: 'bg-white dark:bg-transparent', text: 'text-rose-600 dark:text-rose-300', weight: 'plain' },
    'P-short': { label: 'Short Hours', short: 'P', bg: 'bg-white dark:bg-transparent', text: 'text-amber-600 dark:text-amber-300', weight: 'plain' },
