/**
 * Complaints page tests — list renders, search works, pagination correct.
 */
...
test.describe('Complaints page', () => {
    ...
    test('table or empty state renders', async ({ page }) => {
        ...
        const empty = page.getByText(/no complaints|no grievance/i)
    ...
    test('search filters results', async ({ page }) => {
        ...
        const emptyMsg = await page.getByText(/no complaints|no results/i).isVisible().catch(() => false)
