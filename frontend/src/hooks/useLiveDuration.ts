 ...
 * Returns `'0:00:00'` for nullish / unparseable input.
 *
 * Mirrored in `frontend-portal/src/hooks/useLiveDuration.ts` so the
 * portal and main HR app render the same ticker.
 */
