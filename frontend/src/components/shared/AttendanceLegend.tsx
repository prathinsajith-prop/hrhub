...
//
// Mirrors the same module in `frontend-portal/src/components/shared/`. The
// two apps don't share a package, so the constants are duplicated here —
// but within each app there is now ONE place to add a new code or tweak a
// label/colour. The employee portal's `AttendanceLegend.tsx` is the
// authoritative copy; keep this one in lockstep with it so the two
