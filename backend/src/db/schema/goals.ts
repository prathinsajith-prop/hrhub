 ...
 * themselves in the portal. Separate from performance_reviews (HR-driven
 * review cycles). Tenant + employee scoped, soft-deletable.
 *
 *   status   : 'active' | 'completed' | 'archived'
 *   progress : 0-100 (clamped at the route layer)
 *   category : free-text bucket — 'professional' | 'personal' | 'okr' | …
 */
