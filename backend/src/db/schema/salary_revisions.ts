...
export const salaryRevisions = pgTable('salary_revisions', {
    ...
    previousHousingAllowance: numeric('previous_housing_allowance', { precision: 12, scale: 2 }),
    newHousingAllowance: numeric('new_housing_allowance', { precision: 12, scale: 2 }),
    previousTransportAllowance: numeric('previous_transport_allowance', { precision: 12, scale: 2 }),
    newTransportAllowance: numeric('new_transport_allowance', { precision: 12, scale: 2 }),
    previousOtherAllowances: numeric('previous_other_allowances', { precision: 12, scale: 2 }),
    newOtherAllowances: numeric('new_other_allowances', { precision: 12, scale: 2 }),
    reason: text('reason'),
