...
import { tenants, users, tenantMemberships, entities, employees, gradeLevels, sponsoringEntities, orgUnits, onboardingTemplateSteps, recruitmentStages, salaryComponents, offboardingInterviewQuestions, offboardingExitDocuments, offboardingFlowSettings, shifts } from '../../db/schema/index.js'
...
export async function createTenant(actorUserId: string, input: {
    ...
    return db.transaction(async (tx) => {
        ...
        // 5f. Seed the default "General" shift (09:00–18:00, Fri/Sat off)
        // so the portal's attendance band has a sensible default and HR
        // can assign it to new employees immediately. Editable from
        // Org Settings → Shifts.
